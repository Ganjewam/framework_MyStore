...
public class AccountCreationDetails {
	...
	public void selectTitleMrs() // select radio button Mrs
	{
		titleMrs.click();
	}

	public void selectTitleMr() // select radio button Mr
	{
		titleMr.click();
	}
	...
	public void enterAddressLastName(String lname) // Adding enter here to understand and look like meaningful
	{
		addLastname.clear();
	...
	{
		Select obj = new Select(state);  // Use Select class, create object of Select, import package of Select
